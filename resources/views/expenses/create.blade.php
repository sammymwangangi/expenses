        ...
        <div class="flex">
            ...
            <div class="flex-1 w-4/5 bg-gray-100">
                ...
                <div class="flex justify-between items-center px-6 py-4">
                    ...
                    <h1 class="text-3xl text-gray-500 font-normal">Create Expense</h1>
                            ...
                            <form action="{{route('expenses.store')}}" method="POST">
                                ...
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                        ...
                                        <input type="number" name="cost" id="cost" autocomplete="address-level1" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>

                                    <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                        <label for="date" class="block text-sm font-medium text-gray-700">Expense Date</label>
                                        <input type="date" name="date" id="date" autocomplete="postal-code" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    </div>
                                </div>
