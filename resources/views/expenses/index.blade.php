        ...
        <div class="flex">
            ...
            <div class="flex-1 w-4/5 bg-gray-100">
                ...
                <div class="flex justify-between items-center px-6 py-4">
                    ...
                    <h1 class="text-3xl text-gray-500 font-normal">Expenses</h1>
                    ...
                    <section class="py-8">
                        <div class="container px-4 mx-auto">
                            ...
                            <div class="flex px-6 pb-4 border-b">
                                <h3 class="text-xl font-bold">Recent Expenses</h3>
                            </div>
                            <div class="p-4">
                                <table class="table-auto w-full">
                                <thead>
                                    <tr class="text-xs text-gray-500 text-left">
                                        <th class="pb-3 font-medium">Expense Category</th>
                                        <th class="pb-3 font-medium">Expense Cost </th>
                                        <th class="pb-3 font-medium">Expense Date</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-xs even:tw-bg-gray-50">
                                        <td class="py-5 px-6 font-medium">{{$expense->category->name}}</td>
                                        <td class="font-medium">{{$expense->cost}}</td>
                                        <td class="font-medium">{{$expense->date}}</td>
                                        <td>
                                            <a href="{{route('expenses.edit', $expense['id'])}}" class="inline-block py-1 px-2 text-white bg-blue-500 rounded-full">Edit</a>
                                        </td>
                                        <td>
                                            <a href="{{route('expenses.show', $expense['id'])}}" class="inline-block py-1 px-2 text-white bg-green-500 rounded-full">Show</a>
                                        </td>
                                        <td>
