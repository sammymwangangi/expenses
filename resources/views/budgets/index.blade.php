        ...
        <div class="flex">
            ...
            <div class="flex-1 w-4/5 bg-gray-100">
                ...
                <div class="flex justify-between items-center px-6 py-4">
                    ...
                    <h1 class="text-3xl text-gray-500 font-normal">Budgets</h1>
                    ...
                    <section class="py-8">
                        <div class="container px-4 mx-auto">
                            ...
                            <div class="flex px-6 pb-4 border-b">
                                <h3 class="text-xl font-bold">Recent Budgets</h3>
                            </div>
                            <div class="p-4">
                                <table class="table-auto w-full">
                                <thead>
                                    <tr class="text-xs text-gray-500 text-left">
                                        <th class="pb-3 font-medium">Budget Category</th>
                                        <th class="pb-3 font-medium">Budget Amount </th>
                                        <th class="pb-3 font-medium">Budget From_Date</th>
                                        <th class="pb-3 font-medium">Budget To_Date</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-xs even:tw-bg-gray-50">
                                        <td class="py-5 px-6 font-medium">{{$budget->category->name}}</td>
                                        <td class="font-medium">{{$budget->amount}}</td>
                                        <td class="font-medium">{{$budget->from}}</td>
                                        <td class="font-medium">{{$budget->to}}</td>
                                        <td>
                                            <a href="{{route('budgets.edit', $budget->id)}}" class="inline-block py-1 px-2 text-white bg-blue-500 rounded-full">Edit</a>
                                        </td>
                                        <td>
                                            <a href="{{route('budgets.show', $budget->id)}}" class="inline-block py-1 px-2 text-white bg-green-500 rounded-full">Show</a>
                                        </td>
                                        <td>
