                                ...
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <select type="text" name="parent_id" class="form-control">
                                                ...
                                                @if($categories)
                                                    @foreach($categories as $category)
                                                        <?php $dash=''; ?>
                                                        <option value="{{$budget->category->id}}">{{$budget->category->name}}</option>
                                        ...
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            ...
                                            <input type="number" name="amount" id="amount" autocomplete="address-level1" value="{{$budget->amount}} class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        </div>

                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label for="from" class="block text-sm font-medium text-gray-700">Budget Start Date</label>
                                            <input type="date" name="from" id="from" autocomplete="postal-code" value="{{$budget->from}} class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        </div>

                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label for="to" class="block text-sm font-medium text-gray-700">Budget End Date</label>
                                            <input type="date" name="to" id="to" autocomplete="postal-code" value="{{$budget->to}} class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        </div>
                                    </div>
                                </div>
