        ...
        <div class="flex">
            ...
            <div class="flex-1 w-4/5 bg-gray-100">
                ...
                <div class="flex justify-between items-center px-6 py-4">
                    ...
                    <h1 class="text-3xl text-gray-500 font-normal">{{$category->name}}</h1>
                                ...
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            ...
                                            <input type="text" name="name" id="name" autocomplete="address-level1"  placeholder="Category name" value="{{$category->name}}" required class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        </div>

                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label for="slug" class="block text-sm font-medium text-gray-700">Category Slug*</label>
                                            <input type="text" name="slug" id="slug" autocomplete="address-level1"  placeholder="Category name" value="{{$category->slug}}" required class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            
                                        </div>

                                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                            <label for="date" class="block text-sm font-medium text-gray-700">Select parent category*</label>
